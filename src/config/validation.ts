...
export const validationSchema = Joi.object({
  ...
  APPWRITE_COLLECTION_ORDERS: Joi.string().default('orders'),
  APPWRITE_COLLECTION_PAYMENTS: Joi.string().default('payments'),
  APPWRITE_COLLECTION_INVOICES: Joi.string().default('invoices'),
  APPWRITE_COLLECTION_RECEIPTS: Joi.string().default('receipts'),
